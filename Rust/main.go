...
func main() {
	...
	fmt.Println("Rust Server listening on port 8080...")
...
func handleCompile(w http.ResponseWriter, r *http.Request) {
	...
	tmpFile, err := ioutil.TempFile("", "code-*.rs")
	if err != nil {
	...
	// Compile the code using Rust
	outputFile := tmpOpFile.Name()
	cmd := exec.Command("rustc", tmpFile.Name(), "-o", outputFile)
